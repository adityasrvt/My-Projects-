// Bank Account Management System - JavaScript - Enhanced Version

// Store accounts in localStorage (simulating file storage)
let currentAccount = null;

// Initialize bank code counter
...
// Helper function to generate expiry date (3 years from now)
...
document.getElementById('createAccountForm').addEventListener('submit', function(e) {
    ...
    // Create account object with cards
    const account = {
...
document.getElementById('downloadStatement').addEventListener('click', function() {
    let statement = `SLINGER BANK OF INDIA\n`;
